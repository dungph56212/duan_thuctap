                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Trường cao đẳng FPT Polytechnic</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">tiendung08102005@gmail.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">0878359320</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2022 <b>IPM</b> Được làm bằng <i class="fa fa-heart text-danger"></i> qua <a href="https://hasthemes.com/"><b>HasThemes</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
