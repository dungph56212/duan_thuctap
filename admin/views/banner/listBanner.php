        ...
        <div class="row mb-4">
            <div class="col-lg-3 col-md-6">
                <div class="card banner-stats-card">
                    <div class="card-body">
                        <h6>Tổng Banner</h6>
                        <h3><?= $statistics['total_banners'] ?? 0 ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card banner-stats-card" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                    <div class="card-body">
                        ...
                        <h3><?= $statistics['active_banners'] ?? 0 ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card banner-stats-card" style="background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%);">
                    <div class="card-body">
                        <h6>Tạm Dừng</h6>
                        <h3><?= ($statistics['total_banners'] ?? 0) - ($statistics['active_banners'] ?? 0) ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card banner-stats-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);">
                    <div class="card-body">
                        ...
                        <h3><?= $statistics['total_views'] ?? 0 ?></h3>
                    ...
                    <table class="table table-hover mb-0" id="bannerTable">
                        ...
                        <tbody>
                            ...
                            <?php if (!empty($banner['hinh_anh'])): ?>
                                <img src="<?= BASE_URL . $banner['hinh_anh'] ?>" 
                                     alt="Banner Preview" 
                                     class="img-thumbnail banner-preview" 
                                     style="width: 60px; height: 40px; object-fit: cover; cursor: pointer;"
                                     onclick="showPreview('<?= BASE_URL . $banner['hinh_anh'] ?>', '<?= htmlspecialchars($banner['ten_banner']) ?>')">
                            <?php else: ?>
                                        ...
                                        <td>
                                            <div class="banner-info">
                                                <strong><?= htmlspecialchars($banner['ten_banner']) ?></strong>
                                                <?php if (!empty($banner['description'])): ?>
                                                    <br><small class="text-muted"><?= htmlspecialchars(substr($banner['mo_ta'], 0, 50)) ?>...</small>
                                                <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="text-center">                                <span class="badge badge-<?= $banner['loai_hien_thi'] === 'popup' ? 'info' : 'secondary' ?>">
                                    <?= ucfirst($banner['loai_hien_thi'] ?? 'banner') ?>
                                </span>
                                <br><small class="text-muted">Thứ tự: <?= $banner['thu_tu'] ?? 0 ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">                                <small class="d-block">
                                    <i class="fas fa-eye text-primary"></i> 
                                    <?= number_format($banner['luot_xem'] ?? 0) ?>
                                </small>
                                <small class="d-block">
                                    <i class="fas fa-mouse-pointer text-success"></i> 
                                    <?= number_format($banner['luot_click'] ?? 0) ?>
                                </small>
                                <?php if (($banner['luot_xem'] ?? 0) > 0): ?>
                                    <small class="text-muted">
                                        CTR: <?= number_format((($banner['luot_click'] ?? 0) / $banner['luot_xem']) * 100, 1) ?>%
                                    </small>
                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">
                                                <span class="timeline-dot <?= $banner['trang_thai'] ? 'active' : 'inactive' ?>"></span>                                <div class="custom-control custom-switch status-toggle">
